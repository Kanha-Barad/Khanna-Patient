...
/**-----------------------APP INFO For Khanna PAth ONly---------------------------------------------------- */
String Global_All_Client_Api_URL = "https://mobileappjw.softmed.in";
String Global_Patient_Api_URL = "https://mobileappjw.softmed.in";
String Patient_App_Connection_String =
    "Server=115.112.188.189,11433;User id=app2;Password=Seven@123;Database=UAT_KHANNA_PATH_LIMS;Pooling=false;Min pool size=250;Max pool size=1000";
String All_Client_Logo = "http://137.59.200.62/slims_apps/App_img/khanna.png";
String Patient_report_URL =
    "http://115.112.254.129/KHANNA_testing/PUBLIC/HIMSREPORTVIEWER.ASPX?UNIUQID=";
String Patient_OTP_URL = "";
String SRS_Report =
    "http://115.112.254.129/khanna_testing/qrcodereport.aspx?Bill_id=";
var Client_App_Code = null;
/**-----------------------APP INFO---------------------------------------------------- */
