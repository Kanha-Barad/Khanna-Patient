...
import 'package:khannapatient/TestBooking.dart';
import 'package:loading_indicator/loading_indicator.dart';

import './OrdersHistory.dart';
import './UserProfile.dart';

import 'Test_Enquiry.dart';
...
class _PatientHomeState extends State<PatientHome> {
  ...
  TestEnquiry() async {
    ...
    if (globals.mobNO != "" && globals.mobNO != null) {
      ...
      //     globals.Session_ID != null) {
      Navigator.push(
          context, MaterialPageRoute(builder: (context) => tsetEnquiry()));
    } else if (globals.mobNO == "") {
      Navigator.push(context,
          MaterialPageRoute(builder: (context) => PatientLogin("TENQ")));
    }
  }
